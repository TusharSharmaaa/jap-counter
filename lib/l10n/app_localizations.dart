...
class AppStrings {
  static const _values = <String, Map<String, String>>{
    'en': {
      ...
      'settings.footer.version': 'Naam Jap Counter : Sadhna • V 1.0',
      'settings.footer.madeInIndia': 'Made with devotion in India',
      ...
      'timer.header.title': 'Meditation Timer',
      'timer.duration.label': 'Select time',
      'timer.duration.optionMinutes': '{minutes} minutes',
    ...
    'hi': {
      ...
      'settings.footer.version': 'Naam Jap Counter : Sadhna • संस्करण 1.0',
      'settings.footer.madeInIndia': 'भारत में भक्ति भाव से बनाया गया',
      ...
      'timer.header.title': 'ध्यान टाइमर',
      'timer.duration.label': 'समय चुनें',
      'timer.duration.optionMinutes': '{minutes} मिनट',
